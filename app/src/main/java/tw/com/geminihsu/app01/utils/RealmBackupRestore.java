...
/**
 * Created by geminihsu on 27/12/2016.
 */
...
public class RealmBackupRestore {
    ...
    private String IMPORT_REALM_FILE_NAME = "App01.realm"; // Eventually replace this if you're using a custom db name
    ...
    public RealmBackupRestore(Activity activity) {
        this.realm = new RealmUtil(activity.getApplicationContext()).getmRealm();
