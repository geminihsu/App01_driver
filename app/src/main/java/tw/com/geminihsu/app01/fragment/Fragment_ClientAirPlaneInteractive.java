...
public class Fragment_ClientAirPlaneInteractive extends Fragment {
    ...
    public static Fragment_ClientAirPlaneInteractive newInstance() {
        return new Fragment_ClientAirPlaneInteractive();
    }

    public Fragment_ClientAirPlaneInteractive() {
